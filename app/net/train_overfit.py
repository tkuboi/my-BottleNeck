...
def _main(args):
    ...
    image = PIL.Image.open('images/bottle0.JPG')
    ...
    boxes = np.array([[0,30,114,340,530]])
    ...
    #detectors_mask_shape = (13, 13, 2, 1)
    #matching_boxes_shape = (13, 13, 2, 5)
    ...
    model.compile(
        optimizer='adam', loss=loss_funcs 
